...
extract_peak_seq_in_core_region() {
    ...
    ln -s /picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/1_2rd_initial_evaluation/CAF/motif/peak_seq $core_peak_seq_dir
}
...
locate_motif() {
    ...
    ln -s /picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/1_2rd_initial_evaluation/CAF/motif/motif_loc $motif_bed_dir
}
...
get_block_bed_for_motif() {
    ...
    ln -s /picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/1_2rd_initial_evaluation/CAF/motif/region_loc $region_bed_dir
}
...
get_average_variant_count_each_popu() {
    ...
    for chrom in $(echo $autosomes | tr " " "\n"); do
        ...
        for region_bed in $(echo $regions | tr " " "\n"); do
            if [ $var_type == "transition" ] || [ $var_type == "transversion" ]; then
