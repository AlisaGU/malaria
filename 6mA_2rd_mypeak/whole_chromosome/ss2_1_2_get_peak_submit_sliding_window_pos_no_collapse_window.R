...
write <- function(peak_submit_sliding_window_pos = NULL, chrom = NULL, output_dir = NULL) {
    ...
    a <- sapply(data_by_window, function(x) {
        result <- data.frame(chrom = chrom, start = x[, 1] - 1, end = x[, 2])
        window <- x[1, 3]
...
# chrom <- "Pf3D7_12_v3"
# peak_pos_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/6mA/jiang/2rd/macs2_output/chrom/Pf3D7_12_v3.peak.bed"
# flank_length_type <- "relative"
# flank_length <- "0.05"
# treatment_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/6mA/jiang/2rd/macs2_output/modifi_level/Pf3D7_12_v3.treat.bed"
# control_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/6mA/jiang/2rd/macs2_output/modifi_level/Pf3D7_12_v3.cont.bed"
# output_dir<-"/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/6mA/jiang/2rd/macs2_output/chrom/sliding_window/Pf3D7_05_v3"
# 5. process -------------------------------------------------------------- TODO:
...
write(peak_submit_sliding_window_pos = peak_submit_sliding_window_pos, chrom = chrom, output_dir = output_dir)
