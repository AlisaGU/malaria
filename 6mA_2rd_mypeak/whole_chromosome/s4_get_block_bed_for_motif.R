...
# motif_bed_file<-"/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/1_2rd_initial_evaluation/CAF/motif/motif_loc/Pf3D7_01_v3.motif.bed"
# output_dir<-"/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/1_2rd_initial_evaluation/CAF/motif/region_loc"
# 5. process --------------------------------------------------------------
