...
# 第一幅图
{
    world_all <- plot_mutation_density(
        ...
        sig_y = 0.738, line_y = 0.77, text_y = 0.79, y_min = 0.2, y_max = 0.82,
    ...
    world_snp <- plot_mutation_density(
        ...
        sig_y = 0.499, line_y = 0.52, text_y = 0.53, y_min = 0.1, y_max = 0.54,
    ...
    world_indel <- plot_mutation_density(
        ...
        sig_y = 0.568, line_y = 0.6, text_y = 0.513, y_min = 0.1, y_max = 0.65,
    ...
    Africa_all <- plot_mutation_density(
        ...
        sig_y = 0.73, line_y = 0.76, text_y = 0.78, y_min = 0.2, y_max = 0.81,
    ...
    Africa_snp <- plot_mutation_density(
        ...
        sig_y = 0.49, line_y = 0.51, text_y = 0.51, y_min = 0.1, y_max = 0.53,
    ...
    Africa_indel <- plot_mutation_density(
        ...
        sig_y = 0.55, line_y = 0.58, text_y = 0.51, y_min = 0.1, y_max = 0.61,
    ...
    wsea_all <- plot_mutation_density(
        ...
        sig_y = 0.35, line_y = 0.375, text_y = 0.39, y_min = 0.05, y_max = 0.41,
    ...
    wsea_snp <- plot_mutation_density(
        ...
        sig_y = 0.23, line_y = 0.245, text_y = 0.205, y_min = 0, y_max = 0.252,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    wsea_indel <- plot_mutation_density(
        data_for_plot = data$WSEA$indels_mean_variant_count,
        sig_y = 0.27, line_y = 0.29, text_y = 0.24, y_min = 0.05, y_max = 0.31,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )
...
# 第二幅图
{
    ...
    CAF_snp <- plot_mutation_density(
        ...
        sig_y = 0.092, line_y = 0.94, text_y = 0.96, y_min = 0, y_max = 0.11,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    CAF_indel <- plot_mutation_density(
        data_for_plot = data$CAF$indels_mean_variant_count,
        sig_y = 0.35, line_y = 0.38, text_y = 0.38, y_min = 0.05, y_max = 0.405,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )

    EAF_all <- plot_mutation_density(
        data_for_plot = data$EAF$allvar_mean_variant_count,
        sig_y = 0.55, line_y = 0.575, text_y = 0.595, y_min = 0.1, y_max = 0.605,
    ...
    EAF_snp <- plot_mutation_density(
        ...
        sig_y = 0.36, line_y = 0.38, text_y = 0.39, y_min = 0, y_max = 0.405,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    EAF_indel <- plot_mutation_density(
        data_for_plot = data$EAF$indels_mean_variant_count,
        sig_y = 0.425, line_y = 0.45, text_y = 0.363, y_min = 0.1, y_max = 0.46,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )
...
CAF_all <- plot_mutation_density(
    data_for_plot = data$CAF$allvar_mean_variant_count,
    sig_y = 0.41, line_y = 0.43, text_y = 0.45, y_min = 0.1, y_max = 0.47,
    submit_type = "Central africa", ytitle = "All variants \nmutation density", xlabel = FALSE
)
CAF_snp <- plot_mutation_density(
    data_for_plot = data$CAF$snps_mean_variant_count,
    sig_y = 0.092, line_y = 0.94, text_y = 0.96, y_min = 0, y_max = 0.11,
...
CAF_all / CAF_snp / CAF_indel +
    plot_annotation(tag_levels = "A") &
    theme(plot.tag = element_text(size = 32))
ggsave(paste0(output_path, "/", "CAF.whole.mutation_density.pdf"), width = 10, height = 26)
ggsave(paste0(output_path, "/", "CAF.whole.mutation_density.jpg"), width = 10, height = 26)
