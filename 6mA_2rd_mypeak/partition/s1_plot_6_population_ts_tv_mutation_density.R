...
get_data_for_plot <- function(popu_symbol = NULL, dataname = NULL) {
    path <- paste0("/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/2_2rd_partition/ffd/", popu_symbol, "/mutation_density")
...
plot_mutation_density_1 <- function(data_for_plot = NULL, sig_y = NULL, line_y = NULL, text_y = NULL, y_min = NULL, y_max = NULL, submit_type = NULL, ytitle = NULL, xlabel = NULL) {
...
no_na_inf_index<-intersect(intersect(which(!is.na(no)),
    which(!is.infinite(no))),
    intersect(which(!is.na(index_value)),
...
# 3. input ---------------------------------------------------------------- TODO:
output_path <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/2_2rd_partition/ffd"
...
# 第一幅图
{
    world_ts <- plot_mutation_density(
        ...
        sig_y = 0.105, line_y = 0.112, text_y = 0.118, y_min=-0.001, y_max = 0.13,
    ...
    world_tv <- plot_mutation_density(
        ...
        sig_y = 0.08, line_y = 0.085, text_y = 0.9, y_min=-0.001, y_max = 0.1,
    ...
    world_ratio <- plot_mutation_density(
        ...
        sig_y = 1.85, line_y = 1.925, text_y = 1.9, y_min=0.8, y_max = 2.05,
    ...
    Africa_ts <- plot_mutation_density(
        ...
        sig_y = 0.094, line_y = 0.1, text_y = 0.105, y_min=-0.001, y_max = 0.11,
    ...
    Africa_tv <- plot_mutation_density(
        ...
        sig_y = 0.075, line_y = 0.08, text_y = 0.085, y_min=-0.001, y_max = 0.09,
    ...
    Africa_ratio <- plot_mutation_density(
        ...
        sig_y = 1.93, line_y = 1.99, text_y = 1.97, y_min=0.8, y_max = 2.05,
    ...
    wsea_ts <- plot_mutation_density(
        ...
        sig_y = 0.0165, line_y = 0.017, text_y = 0.019, y_min = -0.001, y_max = 0.0205,
    ...
    wsea_tv <- plot_mutation_density(
        ...
        sig_y = 0.016, line_y = 0.018, text_y = 0.0195, y_min=-0.001, y_max = 0.02,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    wsea_ratio <- plot_mutation_density(
        data_for_plot = data$WSEA$ts_tv_ratio.txt,
        sig_y = 6.35, line_y = 6.45, text_y = 6.45, y_min=-0.1, y_max = 6.5,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )
...
# 第二幅图
{
    WAF_ts <- plot_mutation_density(
        ...
        sig_y = 0.075, line_y = 0.082, text_y = 0.09, y_min=0, y_max = 0.1,
    ...
    WAF_tv <- plot_mutation_density(
        ...
        sig_y = 0.059, line_y = 0.065, text_y = 0.067, y_min=-0.001, y_max = 0.08,
        submit_type = FALSE, ytitle = "Transversion", xlabel = FALSE
    )
    WAF_ratio <- plot_mutation_density(
        data_for_plot = data$WAF$ts_tv_ratio.txt,
        sig_y = 2.1, line_y = 2.2, text_y = 2.35, y_min=0.77, y_max = 2.4,
        submit_type = FALSE, ytitle = "Ts/tv", xlabel = TRUE
    )

    CAF_ts <- plot_mutation_density(
        data_for_plot = data$CAF$transition_mean_variant_count,
        sig_y = 0.021, line_y = 0.023, text_y = 0.024, y_min=-0.001, y_max = 0.026,
    ...
    CAF_tv <- plot_mutation_density(
        ...
        sig_y = 0.0285, line_y = 0.0295, text_y = 0.0315, y_min=-0.001, y_max = 0.0325,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    CAF_ratio <- plot_mutation_density(
        data_for_plot = data$CAF$ts_tv_ratio.txt,
        sig_y = 3.71, line_y = 3.8, text_y = 3.95, y_min=-0.001, y_max = 4.2,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )

    EAF_ts <- plot_mutation_density(
        data_for_plot = data$EAF$transition_mean_variant_count,
        sig_y = 0.046, line_y = 0.046, text_y = 0.049, y_min=-0.001, y_max = 0.055,
    ...
    EAF_tv <- plot_mutation_density(
        ...
        sig_y = 0.03, line_y = 0.032, text_y = 0.0333, y_min=-0.001, y_max = 0.035,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    EAF_ratio <- plot_mutation_density(
        data_for_plot = data$EAF$ts_tv_ratio.txt,
        sig_y = 3.1, line_y = 3.3, text_y = 3.4, y_min=-0.001, y_max = 3.5,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )
