...
# 第一幅图
{
    world_all <- plot_mutation_density(
        ...
        sig_y = 0.74, line_y = 0.77, text_y = 0.79, y_min = 0.15, y_max = 0.82,
    ...
    world_snp <- plot_mutation_density(
        ...
        sig_y = 0.59, line_y = 0.62, text_y = 0.64, y_min = 0.15, y_max = 0.65,
    ...
    world_indel <- plot_mutation_density(
        ...
        sig_y = 0.59, line_y = 0.63, text_y = 0.513,y_min=-0.01,y_max = 0.65,
    ...
    Africa_all <- plot_mutation_density(
        ...
        sig_y = 0.73, line_y = 0.76, text_y = 0.78, y_min = 0.15, y_max = 0.81,
    ...
    Africa_snp <- plot_mutation_density(
        ...
        sig_y = 0.55, line_y = 0.58, text_y = 0.51, y_min = 0.08, y_max = 0.61,
    ...
    Africa_indel <- plot_mutation_density(
        ...
        sig_y = 0.57, line_y = 0.6, text_y = 0.51, y_min = -0.01, y_max = 0.61,
    ...
    wsea_all <- plot_mutation_density(
        ...
        sig_y = 0.26, line_y = 0.28, text_y = 0.29,y_min=-0.01,y_max = 0.31,
    ...
    wsea_snp <- plot_mutation_density(
        ...
        sig_y = 0.18, line_y = 0.2, text_y = 0.205,y_min=-0.01,y_max = 0.21,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    wsea_indel <- plot_mutation_density(
        data_for_plot = data$WSEA$indels_mean_variant_count,
        sig_y = 0.22, line_y = 0.24, text_y = 0.24,y_min=-0.01,y_max = 0.26,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )
    ...
    ggsave(paste0(output_path, "/", "world_africa_wsea.allvar.mutation_density.pdf"), width = 26, height = 26)
}
...
# 第二幅图
{
    ...
    CAF_snp <- plot_mutation_density(
        ...
        sig_y = 0.26, line_y = 0.28, text_y = 0.288,y_min=-0.01,y_max = 0.31,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    CAF_indel <- plot_mutation_density(
        data_for_plot = data$CAF$indels_mean_variant_count,
        sig_y = 0.335, line_y = 0.36, text_y = 0.318,y_min=-0.01,y_max = 0.37,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )

    EAF_all <- plot_mutation_density(
        data_for_plot = data$EAF$allvar_mean_variant_count,
        sig_y = 0.51, line_y = 0.535, text_y = 0.56,y_min=-0.01,y_max = 0.6,
    ...
    EAF_snp <- plot_mutation_density(
        ...
        sig_y = 0.34, line_y = 0.36, text_y = 0.333,y_min=-0.01,y_max = 0.41,
        submit_type = FALSE, ytitle = FALSE, xlabel = FALSE
    )
    EAF_indel <- plot_mutation_density(
        data_for_plot = data$EAF$indels_mean_variant_count,
        sig_y = 0.435, line_y = 0.47, text_y = 0.48,y_min=-0.01,y_max = 0.51,
        submit_type = FALSE, ytitle = FALSE, xlabel = TRUE
    )
    ...
    (WAF_all | CAF_all | EAF_all) / (WAF_snp | CAF_snp | EAF_snp) / (WAF_indel | CAF_indel | EAF_indel) +
        plot_annotation(tag_levels = "A") &
        theme(plot.tag = element_text(size = 32))
    ggsave(paste0(output_path, "/", "WAF_CAF_EAF.allvar.mutation_density.pdf"), width = 26, height = 26)
}