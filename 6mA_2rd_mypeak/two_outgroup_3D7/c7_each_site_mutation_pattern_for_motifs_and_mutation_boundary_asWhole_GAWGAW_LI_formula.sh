...
find_specific_site_for_overlap_motif() {
    cd $single_motif_global_output_dir/GAWGAW/motif_bed
    mkdir -p ../overlap_site1 ../overlap_site2 ../overlap_site3 ../overlap_site4 ../overlap_site5 ../overlap_site6

    for peak_type in $(echo "peak nopeak" | tr " " "\n"); do
        rm -rf $(find ../overlap_site* | grep ${peak_type}.bed)
        for chrom in $(echo $autosomes | tr " " "\n"); do

            awk -v region=${peak_type} '$4=="+"{
                    print $1"\t"$3-6"\t"$3-5"\t"$4 >> "../overlap_site1/"$1"."region".bed";
                    print $1"\t"$3-5"\t"$3-4"\t"$4 >> "../overlap_site2/"$1"."region".bed";
                    print $1"\t"$3-4"\t"$3-3"\t"$4 >> "../overlap_site3/"$1"."region".bed";
                    print $1"\t"$3-3"\t"$3-2"\t"$4 >> "../overlap_site4/"$1"."region".bed";
                    print $1"\t"$3-2"\t"$3-1"\t"$4 >> "../overlap_site5/"$1"."region".bed";
                    print $1"\t"$3-1"\t"$3"\t"$4 >> "../overlap_site6/"$1"."region".bed";

                }$4=="-"{
                    print $1"\t"$3-1"\t"$3"\t"$4 >> "../overlap_site1/"$1"."region".bed";
                    print $1"\t"$3-2"\t"$3-1"\t"$4 >> "../overlap_site2/"$1"."region".bed";
                    print $1"\t"$3-3"\t"$3-2"\t"$4 >> "../overlap_site3/"$1"."region".bed";
                    print $1"\t"$3-4"\t"$3-3"\t"$4 >> "../overlap_site4/"$1"."region".bed";
                    print $1"\t"$3-5"\t"$3-4"\t"$4 >> "../overlap_site5/"$1"."region".bed";
                    print $1"\t"$3-6"\t"$3-5"\t"$4 >> "../overlap_site6/"$1"."region".bed";
                }' ${chrom}.motif.${peak_type}.bed
        done
    done
}
