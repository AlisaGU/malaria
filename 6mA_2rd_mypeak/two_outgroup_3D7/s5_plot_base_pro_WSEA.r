...
A <- plot_mutation_density(
    data_for_plot = data$WSEA$A,
    sig_y = 0.44, line_y = 0.45, text_y = 0.46, y_min = 0.35, y_max = 0.47,
    submit_type = "WSEA", ytitle = "A", xlabel = FALSE
)
T <- plot_mutation_density(
    data_for_plot = data$WSEA$T,
    sig_y = 0.43, line_y = 0.44, text_y = 0.45, y_min = 0.32, y_max = 0.46,
    submit_type = "WSEA", ytitle = "T", xlabel = FALSE
)
C <- plot_mutation_density(
    data_for_plot = data$WSEA$C,
    sig_y = 0.123, line_y = 0.126, text_y = 0.135, y_min = 0.085, y_max = 0.128,
    submit_type = FALSE, ytitle = "C", xlabel = TRUE
)
G <- plot_mutation_density(
    data_for_plot = data$WSEA$G,
    sig_y = 0.128, line_y = 0.132, text_y = 0.135, y_min = 0.085, y_max = 0.135,
