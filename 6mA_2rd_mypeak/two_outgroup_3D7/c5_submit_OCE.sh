...
mutation_density_dir=$global_output_dir/$popu_symbol/mutation_density_two_group_consistent_whole_chromsome
base_proporation_dir=$global_output_dir/$popu_symbol/base_proporation_two_group_consistent_whole_chromsome
