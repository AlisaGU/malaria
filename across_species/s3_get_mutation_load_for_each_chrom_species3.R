...
vcf[, ncol(vcf) := NULL]
# colnames(vcf) <- c("chrom", "pos", "ref", "alt", "P_falciparum", "B_species", "outgroup_A")
colnames(vcf) <- c("chrom", "pos", "ref", "alt", "P_falciparum", "outgroup_A", "B_species")


vcf <- vcf[, c("chrom", "pos", "ref", "alt", "P_falciparum", "outgroup_A", "B_species")]
chrom <- vcf$chrom[1]
