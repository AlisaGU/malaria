...
# file_name <- "motif_bed/Pf3D7_01_v3.motif.peak.bed"
#   cmd<-"grep -E -v \"GAMSAA|GAHGAW\" motif_bed/Pf3D7_01_v3.motif.peak.bed | sort -k1,1 -k2,2n | /picb/evolgen/users/gushanshan/software/bedtools/bedtools merge -i stdin | awk '{print $0\"\\t\"NR}' | /picb/evolgen/users/gushanshan/software/bedtools/bedtools intersect -a motif_bed/Pf3D7_01_v3.motif.peak.bed -b stdin -wb | grep -E -v \"GAMSAA|GAHGAW\""
#   cmd<-"grep -E \"GAMSAA|GAHGAW\" motif_bed/Pf3D7_01_v3.motif.peak.bed | sort -k1,1 -k2,2n | /picb/evolgen/users/gushanshan/software/bedtools/bedtools merge -i stdin | awk '{print $0\"\\t\"NR}' | /picb/evolgen/users/gushanshan/software/bedtools/bedtools intersect -a motif_bed/Pf3D7_01_v3.motif.peak.bed -b stdin -wb | grep -E  \"GAMSAA|GAHGAW\""
