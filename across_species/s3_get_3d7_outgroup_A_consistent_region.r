...
output <- paste0("/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/across_species/two_outgroup_consistent/", names(seq_data)[2], "/", chrom, ".two_consistent_region.bed")
...
pos <- which(P_falciparum != "n" & P_falciparum != "-" & P_falciparum == outgroup_A)
