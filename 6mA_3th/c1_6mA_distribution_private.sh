...
working_dir="/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/6mA/jiang/3th/private"
...
cd $working_dir
prefix=""
m6mA_3th_bed="3D7-6mA-3seq${prefix}.bed"
validate_6mA_sliding_window_distribution_in_3th_data
validate_6mA_motif_flank_pattern_in_3th_data

# for prefix in $(echo "_COVgt25,_COVgt50,_QVgt20_COVgt10" | tr "," "\n"); do
#     m6mA_3th_bed="3D7-6mA-3seq${prefix}.bed"
#     # validate_6mA_sliding_window_distribution_in_3th_data
#     validate_6mA_motif_flank_pattern_in_3th_data
# done
