...
code_dir="/picb/evolgen2/users/gushanshan/projects/malaria/code/xiao_plot/gene_6mA_density_signal/R_stage"
working_dir="/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/gene_6mA_density_signal/R_stage"
...
samtools flagstat $bam_dir/3D7-4th-R_ChIP.bam >$chip_summary
samtools flagstat $bam_dir/3D7-4th-R_Input.bam >$input_summary
