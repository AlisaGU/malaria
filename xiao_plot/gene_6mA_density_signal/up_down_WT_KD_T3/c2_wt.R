...
gene_up <- read.data(prefix = "up", part = "gene", type = "wt")
gene_down <- read.data(prefix = "down", part = "gene", type = "wt")
tss_up <- read.data(prefix = "up", part = "tss", type = "wt")
tss_down <- read.data(prefix = "down", part = "tss", type = "wt")
tts_up <- read.data(prefix = "up", part = "tts", type = "wt")
tts_down <- read.data(prefix = "down", part = "tts", type = "wt")
...
ggsave("WT.pdf", width = 10, height = 7)


data_for_plot$type <- "WT"
data_for_plot_wt <- data_for_plot
save(data_for_plot_wt, file = "data_for_plot_wt.Rdata")
