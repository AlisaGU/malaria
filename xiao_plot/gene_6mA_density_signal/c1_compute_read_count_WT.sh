...
# FUNCTIONS TODO:
get_5712_genes_bed() {
    awk '$3=="gene"{split($9,a,";");split(a[1],b,"=");print $1"\t"$4-1"\t"$5"\t"b[2]}' $anno | sort -k1,1 -k2,2n >$all_genes_bed
}
...
set -ex
# get_5712_genes_bed
# samtools flagstat $bam_dir/3D7-T3_ChIP.bam >$chip_summary
# samtools flagstat $bam_dir/3D7-T3_Input.bam >$input_summary
