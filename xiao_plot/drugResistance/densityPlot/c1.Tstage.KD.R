...
gene_chip_info_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/gene_6mA_density_signal/KD/chip.gene_flank2kb.inter"
gene_input_info_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/gene_6mA_density_signal/KD/input.gene_flank2kb.inter"
...
upgene_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/drugResistance/densityPlot/Tstage/KD.up_list"
downgene_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/drugResistance/densityPlot/Tstage/KD.down_list"
...
up | down
ggsave("/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/drugResistance/densityPlot/Tstage/drugResist_T_KD_upDown.pdf", width = 14, height = 5)
