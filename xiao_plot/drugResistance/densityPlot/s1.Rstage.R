...
RNA_filename <- "/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/gene_6mA_density_signal/3D7_RNA_Rstage_new.txt" ## 这里放RNA只是为了偷懒不改代码，实际没有任何意义。也不可参与任何结果的输出。


upgene_filename <- paste0("/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/drugResistance/densityPlot/Rstage/", group, ".up_list")
downgene_filename <- paste0("/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/drugResistance/densityPlot/Rstage/", group, ".down_list")
...
up | down
ggsave(paste0("/picb/evolgen/users/gushanshan/projects/malaria/dataAndResult/xiao_plot/drugResistance/densityPlot/Rstage/", group, ".Rstage_WT_updown.pdf"), width = 14, height = 5)
